        ...
        >
            <div className="mb-2 flex items-center justify-between gap-2">
                <div className="flex min-w-0 items-baseline gap-2">
                    <div className="shrink-0 text-xs font-semibold">{hostManagedGeneration ? "分镜策划" : "组装提示词"}</div>
            ...
            <div className="relative rounded-xl">
                {!value.trim() ? <div className="pointer-events-none absolute left-3 top-2 text-sm leading-7" style={{ color: theme.node.placeholder }}>{hostManagedGeneration ? "输入或修改本镜头策划，按 @ 引用连接素材" : "输入提示词，按 @ 引用连接的图片或文本"}</div> : null}
                <div
                    ref={editorRef}
                    contentEditable
